...
function ProfileInput({ label, field, value, type = 'number', onChange }: {
  label: string;
  ...
  return (
    <div>
      ...
      <input
        ...
        value={value}
        onChange={e => onChange({ [field]: type === 'number' ? +e.target.value : e.target.value } as Partial<UserProfile>)}
      />
    </div>
  );
}
    ...
    <div className="space-y-5 max-w-2xl">
      <Card className="p-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <ProfileInput label="Your Age" field="age" value={profile.age} onChange={updateProfile} />
          <ProfileInput label="Spouse Age" field="spouseAge" value={profile.spouseAge} onChange={updateProfile} />
          <ProfileInput label="Number of Children" field="children" value={profile.children} onChange={updateProfile} />
          <div>
      ...
      <Card className="p-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <ProfileInput label="Annual Salary" field="salary" value={profile.salary} onChange={updateProfile} />
          <ProfileInput label="Annual Bonus" field="annualBonus" value={profile.annualBonus} onChange={updateProfile} />
          <ProfileInput label="Employee 401k Contribution" field="employee401kContribution" value={profile.employee401kContribution} onChange={updateProfile} />
          <ProfileInput label="Employer Match" field="employerMatch401k" value={profile.employerMatch401k} onChange={updateProfile} />
          <ProfileInput label="Retirement Spending (Before SS)" field="retirementSpendingBeforeSS" value={profile.retirementSpendingBeforeSS} onChange={updateProfile} />
          <ProfileInput label="Retirement Spending (After SS)" field="retirementSpendingAfterSS" value={profile.retirementSpendingAfterSS} onChange={updateProfile} />
        </div>
      </Card>
